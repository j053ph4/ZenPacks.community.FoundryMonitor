...
NAME = "ZenPacks.community.FoundryMonitor"
VERSION = "1.1"
AUTHOR = "Joseph Anderson"
LICENSE = "Apache"
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.community']
PACKAGES = ['ZenPacks', 'ZenPacks.community', 'ZenPacks.community.FoundryMonitor']
INSTALL_REQUIRES = ['ZenPacks.community.ConstructionKit>=2.0']
