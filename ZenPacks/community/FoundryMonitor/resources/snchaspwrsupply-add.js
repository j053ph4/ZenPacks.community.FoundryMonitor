...
(function() {
            ...
            Ext.ComponentMgr.onAvailable('component-add-menu', function(config) {
                ...
                menuButton.menuItems.push({
                    xtype: 'menuitem',
                    text: _t('Add Power Supply') + '...',
                    hidden: Zenoss.Security.doesNotHavePermission('Manage Device'),
                    handler: function() {
                        var win = new Zenoss.dialog.CloseDialog({
                            width: 300,
                            title: _t('Add Power Supply'),
                            items: [{
                                xtype: 'form',
                                buttonAlign: 'left',
                                monitorValid: true,
                                ...
                                items:                         [
                            {
                                ...
                                width: 260, 
                                id: 'snChasPwrSupplyDescriptionField', 
                                xtype: 'textfield'
                            }
                        ]
                                ...
                                buttons: [{
                                    ...
                                    handler: function(b) {
                                        ...
                                        Zenoss.remote.FoundryMonitorRouter.addsnChasPwrSupplyRouter(opts,
                                        function(response) {
                                            if (response.success) {
                                                new Zenoss.dialog.SimpleMessageDialog({
                                                    title: _t('Power Supply Added'),
